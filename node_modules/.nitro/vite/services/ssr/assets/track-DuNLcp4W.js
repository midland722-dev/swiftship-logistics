import { t as Route } from "./track-DxdnxYc9.js";
import { useEffect, useState } from "react";
import { useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { CheckCircle2, Circle, MapPin } from "lucide-react";
//#region src/lib/track-api.ts
...
//#endregion
//#region src/routes/track.tsx?tsr-split=component
var STATUS_LABELS = {
	pending: {
		label: "Pending",
		color: "#6b7280"
		...
		children: [
			...
			data && si && /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("span", { children: data.shipment.origin_city ?? "Origin" }), /* @__PURE__ */ jsx("span", { children: data.shipment.destination_city ?? "Destination" })]
								}),
								/* @__PURE__ */ jsx("div", {
								...
								return /* @__PURE__ */ jsxs("li", {
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("div", {
											...
											children: isDone ? /* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4" }) : /* @__PURE__ */ jsx(Circle, { className: "h-3 w-3" })
										}), !isLast && /* @__PURE__ */ jsx("div", { className: `mt-1 h-8 w-px ${isDone ? "bg-brand/50" : "bg-border"}` })]
									}), /* @__PURE__ */ jsxs("div", {
					...
					className: "space-y-4",
					children: [
						/* @__PURE__ */ jsxs(InfoCard, {
							title: "Route",
							children: [/* @__PURE__ */ jsx(RouteRow, {
								icon: MapPin,
								label: "From",
...
function RouteRow({ icon: Icon, label, value }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(Icon, { className: "h-4 w-4 text-brand" }), /* @__PURE__ */ jsxs("div", {
