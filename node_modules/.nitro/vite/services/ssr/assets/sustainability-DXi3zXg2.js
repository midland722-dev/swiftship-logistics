...
import { Leaf, Recycle, Wind, Zap } from "lucide-react";
...
function SustainabilityPage() {
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		/* @__PURE__ */ jsxs("section", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("h1", {
					...
					children: ["Net-zero logistics by ", /* @__PURE__ */ jsx("span", {
		...
		/* @__PURE__ */ jsx("section", {
			...
			children: pillars.map(({ icon: Icon, title, desc }) => /* @__PURE__ */ jsxs("div", {
