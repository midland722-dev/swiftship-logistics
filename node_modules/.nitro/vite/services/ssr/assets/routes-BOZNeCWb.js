import { n as express_handoff_default, t as cargo_port_default } from "./cargo-port-BARjQwb4.js";
import { useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { ArrowRight, Building2, FileText, Leaf, Lightbulb, Newspaper, Package, Plane, Search, Ship, Truck, Warehouse } from "lucide-react";
//#region src/assets/american-shipping-hero.jpg
var american_shipping_hero_default = "/assets/american-shipping-hero--WTupvYl.jpg";
//#endregion
//#region src/assets/sustainability-van.jpg
var sustainability_van_default = "/assets/sustainability-van-DjoVtKcX.jpg";
//#endregion
//#region src/assets/innovation-data.jpg
var innovation_data_default = "/assets/innovation-data-0yhncJlr.jpg";
//#endregion
//#region src/assets/global-planes.jpg
...
function HomePage() {
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		...
		/* @__PURE__ */ jsx(BusinessSplit, {}),
		/* @__PURE__ */ jsx(Updates, {}),
...
function Hero() {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-0 bg-gradient-to-r from-brand via-brand/85 to-brand/30" }),
			/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-0 grid-lines opacity-30" }),
			/* @__PURE__ */ jsxs("div", {
...
function QuickActions() {
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsx("div", {
			...
			children: [
			...
			].map(({ icon: Icon, title, desc, to }) => /* @__PURE__ */ jsxs(Link, {
				to,
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [title, /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4 -translate-x-1 opacity-0 transition group-hover:translate-x-0 group-hover:opacity-100" })]
					}), /* @__PURE__ */ jsx("p", {
						className: "mt-1 text-sm text-muted-foreground",
						children: desc
					})]
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [
				...
				/* @__PURE__ */ jsxs(Link, {
					...
					children: ["Explore our solutions ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
				})
			] }), /* @__PURE__ */ jsx("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("ul", {
								...
								children: [
									...
									children: [/* @__PURE__ */ jsx("span", { className: "mt-1.5 h-1 w-1 rounded-full bg-accent" }), f]
								}, f))
							}),
							/* @__PURE__ */ jsxs(Link, {
								to: "/services",
								...
								children: ["Explore American Shipping Express ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
							})
						]
					}),
					/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: row.items.map(({ icon: Icon, title, desc }) => /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("ul", {
					...
					].map((u) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs("a", {
						href: "#",
						className: "group flex items-center justify-between gap-4 px-5 py-4 hover:bg-surface",
						children: [/* @__PURE__ */ jsx("span", {
							className: "text-sm font-medium",
							children: u
						}), /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4 shrink-0 text-accent transition group-hover:translate-x-1" })]
					}) }, u))
				}), /* @__PURE__ */ jsxs("div", {
...
function Highlights() {
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsx("div", {
			...
			].map(({ icon: Icon, title, desc, detail, image, alt }) => /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("span", {
							...
							children: ["Learn more ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4 transition group-hover:translate-x-1" })]
						})
					]
				})]
			}, title))
