...
//CONSULTA
$result = mysql_query("SELECT * FROM courier WHERE  status ='In Transit' AND book_mode ='ToPay' AND book_date  BETWEEN '".mysql_real_escape_string($desde)."' AND '".mysql_real_escape_string($hasta)."' ");
