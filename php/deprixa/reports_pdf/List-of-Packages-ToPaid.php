...
//CONSULTA
$result = mysql_query("SELECT * FROM courier WHERE  book_mode = 'ToPay'  AND officename='".mysql_real_escape_string($_SESSION["user_type"])."' AND book_date   BETWEEN '".mysql_real_escape_string($desde)."' AND '".mysql_real_escape_string($hasta)."' ");
