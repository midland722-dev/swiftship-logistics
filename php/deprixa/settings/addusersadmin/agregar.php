...
$checkStmt = $dbConn->prepare("SELECT email,name FROM manager_admin WHERE email=:email OR name=:name");
...
$insertStmt = $dbConn->prepare("INSERT INTO manager_admin (name_parson,name,email,phone,office,role,pwd,estado,type,date) VALUES (:name_parson,:name,:email,:phone,:office,:role,:pwd,:estado,:type,CURDATE())");
$insertStmt->execute([
