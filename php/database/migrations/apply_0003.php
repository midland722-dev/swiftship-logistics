<?php
/**
 * Migration 0003 applier — idempotent.
 * Aligns status enum, back-fills tracking_history, and adds indexes.
 */

require_once __DIR__ . '/../../includes/db.php';

$db = getDB();
$sqlFile = __DIR__ . '/0003_unify_history_and_status.sql';
...
echo "Migration 0003 applied. statements_ok=$ok warnings_or_skipped=$fail\n";
