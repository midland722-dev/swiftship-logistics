<?php
/**
 * Migration 0001 applier — idempotent.
 * Creates the tracking_history table if it does not exist.
 */

require_once __DIR__ . '/../../includes/db.php';

$db = getDB();
$sqlFile = __DIR__ . '/0001_tracking_history.sql';
...
echo "Migration 0001 applied. statements_ok=$ok warnings_or_skipped=$fail\n";
