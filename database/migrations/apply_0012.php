<?php
/**
 * Migration 0012 applier — idempotent.
 * Adds customer-scoped shipment/payment indexes and reports indexes.
 */

require_once __DIR__ . '/../../includes/db.php';

$db = getDB();
$sqlFile = __DIR__ . '/0012_customer_indexes.sql';
...
echo "Migration 0012 applied. statements_ok=$ok warnings_or_skipped=$fail\n";
