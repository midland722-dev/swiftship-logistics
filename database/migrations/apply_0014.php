<?php
/**
 * Migration 0014 applier — idempotent, mirrors existing apply_*.php scripts.
...
$db = getDB();
$sqlFile = __DIR__ . '/0014_fastship_carrier.sql';
...
echo "Migration 0014 applied. statements_ok=$ok warnings_or_skipped=$fail\n";
