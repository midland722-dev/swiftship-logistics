<?php
/**
 * Migration 0011 applier — idempotent.
 * Adds deprixa_customer_id / deprixa_booking_id mapping columns and indexes.
 */

require_once __DIR__ . '/../../includes/db.php';

$db = getDB();
$sqlFile = __DIR__ . '/0011_deprixa_unification.sql';
...
echo "Migration 0011 applied. statements_ok=$ok warnings_or_skipped=$fail\n";
