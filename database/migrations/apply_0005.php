<?php
/**
 * Migration 0005 applier — idempotent.
 * Adds missing PRIMARY KEYs and performance indexes.
 */

require_once __DIR__ . '/../../includes/db.php';

$db = getDB();
$sqlFile = __DIR__ . '/0005_add_missing_primary_keys.sql';
...
echo "Migration 0005 applied. statements_ok=$ok warnings_or_skipped=$fail\n";
